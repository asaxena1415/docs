...
```json Standard Event
{
  ...
  "conversation": {
    "id": "conv_123456",
    "message_count": 5,
    "last_message": "Can you help me track my order?",
    "ai_response": "I'd be happy to help you track your order. Could you please provide your order number?"
  },
  "metadata": {
...
```json User Signup Event
{
  ...
  "user": {
    ...
    "email": "john.doe@example.com",
    "name": "John Doe",
    "signup_date": "2024-01-15T14:25:00.000Z"
  }
}
```

```json Custom Condition Event
{
  "event": "custom_condition_met",
  "timestamp": "2024-01-15T14:35:00.000Z",
  "app_id": "app_abc123",
  "app_name": "Sales Assistant",
  "condition": "User asked about pricing",
  "user": {
    "id": "user_xyz789",
...
| `app_id` | string | Unique identifier for your CalStudio app |
| `app_name` | string | Display name of your app |
| `user.id` | string | Unique user identifier |
| `user.email` | string | User's email address (if available) |
| `user.name` | string | User's display name |
| `conversation.id` | string | Unique conversation identifier |
| `conversation.last_message` | string | Most recent user message |
| `conversation.ai_response` | string | AI's response to the user |
