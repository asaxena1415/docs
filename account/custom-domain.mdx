...
<Note>
  The screenshots below demonstrate the process of publishing a Custom GPT to a custom domain using CalStudio.
</Note>
...
### 2. Create Your App
Click the "Create App" button in your dashboard to begin building your Custom GPT.

### 3. Configure Your AI App
Fill in the essential details:
- Choose your preferred AI model (GPT-4, GPT-3.5, Claude, etc.)
- Set a clear name and description
- Define the system prompt to customize your AI's behavior
- Optionally add a knowledge base for specialized information

### 4. Test and Launch
After creation, test your app thoroughly in the dashboard. Once satisfied, launch it to make it publicly accessible.

### 5. Publish to Custom Domain
In the Status section, click "Publish" to see the publishing options:

<img src="/images/publish-modal.png" alt="CalStudio Publish Modal" width="600" />

Select "Custom Domain" from the available publishing options. You'll then be prompted to enter your domain name:

<img src="/images/publish-modal-domain-input.png" alt="CalStudio Custom Domain Input" width="600" />

Enter your domain name (root domain like `yourdomain.com` or subdomain like `app.yourdomain.com`).
